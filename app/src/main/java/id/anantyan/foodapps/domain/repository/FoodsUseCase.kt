...
class FoodsUseCase(
    ...
    fun executeResults(type: String?): Flow<UIState<List<ResultsItem>>> = foodsRemoteRepository.results(type)
    fun executeResult(id: Int?): Flow<UIState<RecipeResponse>> = foodsRemoteRepository.result(id)
